  ...
  const tariffs = [
    {
      ...
      price: '70',
      icon: 'Package',
      features: ['Без абонплаты', 'Быстрый вывоз', 'До 10 кг', 'Только бытовой мусор']
    },
    {
      id: 'weekly',
      name: 'Неделя',
    ...
    },
    {
      ...
      period: '/месяц',
      icon: 'CalendarCheck',
      features: ['Вынос мусора еженедельно', 'Понедельник, среда, суббота', 'До 10 кг за раз', 'Только бытовой мусор']
    }
  ];
