          ...
          <div className="bg-[#90C850] rounded-lg p-6 mb-5 max-w-5xl mx-auto shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-white text-left text-base">
              ...
              <div>
                ...
                <p className="mb-3">43, 43/1, 43/2, 43/3, 43/5, 44, 44/1, 44/2, 45, 45/1, 45/3, 45/4, 46, 46/2, 47, 47/1, 47А, 48, 52, 52/1, 52/2, 54/1, 56, 58, 58/1, 62, 64, 64/2, 64/3, 64/4, 66, 67/1, 67/2, 67/3, 67/4, 68, 70, 70/1, 70/2, 72, 72/1, 72/2, 74, 76</p>
