        ...
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <div className="bg-[#90C850] rounded-lg p-6 mb-5 max-w-5xl mx-auto shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-white text-left text-xl">
              ...
              <div>
                <p className="font-bold mb-1.5">РОДИМЦЕВА:</p>
                <p className="mb-3">1, 2, 3, 4, 5, 6, 7, 7/1, 8, 8/1, 9, 10, 10/1, 11, 12, 13, 14/1, 15, 16, 18/1, 18/2, 20, 20/1, 22, 22/1</p>
                
                <p className="font-bold mb-1.5">ПР-Д СЕВЕРНЫЙ:</p>
                <p className="mb-3">7, 8, 9, 10, 16, 16/1, 18, 20, 20/1</p>
                
                <p className="font-bold mb-1.5">САМОРЯДОВА:</p>
                <p className="mb-3">2, 4, 6</p>
                
                <p className="font-bold mb-1.5">САЛМЫШСКАЯ:</p>
                <p className="mb-3">43, 43/1, 43/2, 43/3, 43/5, 44, 44/1, 44/2, 45, 45/1, 45/3, 45/4, 46, 46/2, 47, 47/1, 47А, 48, 52, 52/1, 52/2, 54/1, 56, 58, 58/1, 58/2, 62, 64, 64/2, 64/3, 64/4, 66, 67/1, 67/2, 67/3, 67/4, 68, 70, 70/1, 70/2, 72, 72/1, 72/2, 74, 76</p>
                
                <p className="font-bold mb-1.5">ТРАНСПОРТНАЯ:</p>
                <p className="mb-3">7, 7А, 12/1, 16, 16/1, 16/2, 16/3, 16/4, 16Б, 18, 18/2</p>
            ...
            <div className="border-t pt-5">
              ...
              <ol className="space-y-3 text-base">
                ...
                <li className="flex gap-3">
                  ...
                  <span>В комментарии к переводу <strong>обязательно укажите ваш адрес</strong> — улица, дом, подъезд, этаж, номер квартиры</span>
                </li>
                <li className="flex gap-3">
