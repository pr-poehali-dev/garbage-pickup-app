    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="border rounded-lg p-6 md:p-8 mb-8 text-sm leading-relaxed text-gray-800 space-y-4">
          ...
          <p>
            3.1. Стоимость услуг по настоящему Договору составляет <strong>1000 (одна тысяча) рублей</strong> за весь период действия Договора.
          </p>
          <p>
            3.2. Оплата производится Заказчиком путём перевода денежных средств на счёт Исполнителя по номеру телефона +7 (903) 390-10-93 (ВТБ банк) с момента подписания Договора.
          </p>
