    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="border rounded-lg p-6 md:p-8 mb-8 text-sm leading-relaxed text-gray-800 space-y-4">
          ...
          <p>
            2.1. Настоящий Договор вступает в силу с момента его подписания и действует в течение <strong>1 (одного) календарного месяца</strong> — с {formatDate(today)} по {formatDate(endDate)} г.
          </p>
          ...
          <p>
            3.2. Оплата производится Заказчиком путём перевода денежных средств на счёт Исполнителя по номеру телефона +7 (961) 929-67-28 (Альфа-Банк) в течение 3 (трёх) рабочих дней с момента подписания Договора.
          </p>
